      ...
      <div className="w-full">
        <div className="relative w-full">
          <input
            ...
            onBlur={props.onBlur || props.handleBlur}
            value={
          ...
          {props.type === "password" && (
            <span
              ...
              className={`absolute end-0 top-1/2 -translate-y-1/2 text-[#262626] text-md z-10 cursor-pointer ${props.className}`}
            >
              {type === "password" ? <HiEyeOff /> : <HiEye />}
            </span>
          )}
